...
const faqs = [
  ...
  },
  {
    ...
    a: 'Los retornos se acreditan en tu billetera Suelo en la moneda del proyecto (USD, USDT, PYG o BOB). Desde ahí podés retirar a tu cuenta bancaria, a Mercado Pago, o mantener invertido.',
  },
  {
  ...
  },
  {
    ...
    a: 'Suelo opera con foco inicial en Paraguay y Bolivia. Los contratos se adaptan a normativa local y la emisión fiscal se habilita únicamente con proveedor real: SIFEN/DNIT para Paraguay y SIN para Bolivia.',
  },
  {
