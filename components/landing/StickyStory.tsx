...
const scenes: Scene[] = [
  ...
  },
  {
    ...
    titleAccent: 'USD 100.',
    description: 'Elegí monto y moneda disponible. El contrato se firma digitalmente y queda con trazabilidad pública.',
    icon: Wallet,
    accent: 'earth',
  },
  {
    ...
    title: 'Tu SHA-256,',
    titleAccent: 'público.',
    description: 'Cada contrato genera un hash. Podés verificarlo públicamente y confirmar que no fue alterado.',
    icon: FileCheck2,
    accent: 'terra',
  },
  {
